...
description: "Use Deck by PromptPHP with Laravel AI SDK agents for automatic prompt loading, version tracking, and performance monitoring."
sidebarTitle: "Laravel AI SDK"
---

## Introduction

Deck by PromptPHP provides first-class, optional integration with the [Laravel AI SDK](https://laravel.com/docs/ai-sdk). When the AI SDK is installed, you get:
