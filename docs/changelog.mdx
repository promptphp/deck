...
<Warning>
  Tracking now defaults to **off**. If you published `config/deck.php` you are unaffected. If you did not and you rely on tracking, set `DECK_TRACKING_ENABLED=true`. If you use tracking, re-publish and run the migrations. See the [upgrade guide](https://github.com/promptphp/deck/blob/0.x/UPGRADE.md).
</Warning>
