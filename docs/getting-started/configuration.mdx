---
title: "Configuration"
description: "All available configuration options for Deck by PromptPHP."
---
...
Tracking is **off by default**, because it needs database tables that are published in a separate step. Turning it on takes three steps:
