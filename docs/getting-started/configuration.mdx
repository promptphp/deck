---
title: "Configuration"
description: "All available configuration options for Prompt Deck."
---
...
'cache' => [
    ...
    'prefix'  => env('CACHE_PREFIX', env('DECK_CACHE_PREFIX', 'prompt-deck:')),
],
```
...
When the [Laravel AI SDK](https://laravel.com/docs/ai-sdk) is installed and this option is `true`, Prompt Deck automatically creates a matching prompt directory whenever you run `php artisan make:agent`. See the [AI SDK Integration](/integrations/ai-sdk) documentation for details.
